...
This repository includes the original upstream reference assets for this skill:
...
These resources are preserved mainly as reference material. Some examples use the upstream Python/Anthropic stack and should be adapted to this repository's Go/Qwen implementation style before direct reuse.
